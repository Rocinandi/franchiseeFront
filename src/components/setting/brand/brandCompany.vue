    ...
    <div class="page">
       <div class="emp-cont">
        ...
        <ul class="add-store">
            ...
            <li>
                <span class="add-left"><i>*</i>企业名称：</span>
                <div class="add-right">
                    <input type="text" class="inputBox">
                </div>
            </li>
            <li>
                <span class="add-left"><i>*</i>法人：</span>
                <div class="add-right">
                    <input type="text" class="inputBox">
                </div>
            </li>
            <li>
                <span class="add-left"><i>*</i>法人身份证：</span>
                <div class="add-right">
                    <div class="upload">
                        <p>+</p>
                        <span>上传正面</span>
             ...
             <li>
                <span class="add-left"><i>*</i>营业执照：</span>
                <div class="add-right">
                    <div class="upload">
                        <p>+</p>
                        <span>上传图片</span>
            ...
            <li>
                <span class="add-left"><i>*</i>营业执照号：</span>
                <div class="add-right">
                    <input type="text" class="inputBox">
                </div>
            </li>
